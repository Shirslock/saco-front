...
const EXPEDIENTES_ABOGADO = [
  ...
  // Siniestro en cruce Av. Libertador — el mismo hecho generó demanda, mediación y oficio
  {
    ...
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'C-0045/2025', area: 'CIVIL', tipo: 'MEDIACION', caratula: 'Mediación prejudicial — Rodríguez c/ SOFSE', estado: 'EN_TRAMITE', estadoLabel: 'Tramitando', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'FSM-22041/2025', abogado: 'Dr. Alejandro Rossi' },
      { id: 'C-0046/2025', area: 'CIVIL', tipo: 'OFICIO',    caratula: 'Oficio Juzgado Federal N°3 — solicitud de información técnica', estado: 'EN_TRAMITE', estadoLabel: 'Tramitando', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'FSM-22041/2025', abogado: 'Dr. Alejandro Rossi' },
    ],
  ...
  // ── PENAL: Dra. Carla Ibáñez — Línea San Martín / Tren de la Costa ──────
  // Causa CFP-3310/2025 — querella + oficio
  {
    id: 'P-0062/2025', area: 'PENAL', tipo: 'QUERELLA',
    caratula: 'SOFSE querellante — Sustracción de cables de señalización Línea San Martín (Km 22)',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°3 — CABA',
    numero_causa: 'CFP-3310/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-03-10', fecha_recepcion: '2025-03-28',
    abogado: 'Dra. Carla Ibáñez', linea: 'LSM', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-02801-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'P-0063/2025', area: 'PENAL', tipo: 'OFICIO', caratula: 'Oficio JFCC N°3 — solicitud de antecedentes técnicos LSM Km 22', estado: 'EN_TRAMITE', estadoLabel: 'En trámite', tipo_relacion: 'MISMA_CAUSA', numero_causa: 'CFP-3310/2025', abogado: 'Dra. Carla Ibáñez' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Querella por sustracción de cables que provocó interrupción del servicio. Juzgado requirió informe técnico.',
  },
  {
    id: 'P-0063/2025', area: 'PENAL', tipo: 'OFICIO',
    caratula: 'Oficio JFCC N°3 — solicitud de antecedentes técnicos s/ sustracción cables LSM Km 22',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°3 — CABA',
    numero_causa: 'CFP-3310/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-03-10', fecha_recepcion: '2025-04-15',
    abogado: 'Dra. Carla Ibáñez', linea: 'LSM', prioridad: 'NORMAL',
    tiene_alerta: true, alerta_msg: 'Plazo de respuesta vence 05/05/2026',
    gde: 'EX-2025-03102-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'El juzgado solicita antecedentes técnicos de la instalación eléctrica del tramo.',
  },
  // Carta Suceso suelta — Tren de la Costa
  {
    id: 'P-0094/2026', area: 'PENAL', tipo: 'CARTA_SUCESO',
    caratula: 'Agresión a personal de tren — Formación 88 Tren de la Costa Est. Mariposas',
    juzgado: 'Sin juzgado asignado aún',
    numero_causa: '',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2026-04-18', fecha_recepcion: '2026-04-19',
    abogado: 'Dra. Carla Ibáñez', linea: 'TDC', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'MAIL-SAE-2026-0092',
    canal_ingreso: 'MAIL',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Carta Suceso SAE-0092. Pasajero agredió al guarda. Pendiente de denuncia policial.',
  },

  // ── PENAL: Dr. Ramón Pereyra — Línea General Roca ────────────────────────
  // Causa CFP-9901/2024 — defensa penal + pedido de causa penal
  {
    id: 'P-0048/2024', area: 'PENAL', tipo: 'DEFENSA_PENAL',
    caratula: 'Defensa penal maquinista Ríos, Alberto — atropellamiento PH Quilmes Línea Roca',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°8 — CABA',
    numero_causa: 'CFP-9901/2024',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2024-02-14', fecha_recepcion: '2024-03-01',
    abogado: 'Dr. Ramón Pereyra', linea: 'LGR', prioridad: 'ALTA',
    tiene_alerta: true, alerta_msg: 'Audiencia indagatoria: 12/05/2026',
    gde: 'ME-2024-00312-APN-SACO#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [
      { id: 'P-0049/2024', area: 'PENAL', tipo: 'PEDIDO_CAUSA_PENAL', caratula: 'Pedido de causa penal — incidente PH Quilmes LGR', estado: 'CUMPLIDO', estadoLabel: 'Solicitud cumplida', tipo_relacion: 'MISMA_CAUSA', numero_causa: 'CFP-9901/2024', abogado: 'Dr. Ramón Pereyra' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Maquinista imputado por homicidio culposo en paso a nivel. Próxima audiencia indagatoria.',
  },
  {
    id: 'P-0049/2024', area: 'PENAL', tipo: 'PEDIDO_CAUSA_PENAL',
    caratula: 'Pedido de causa penal — atropellamiento paso a nivel Quilmes Línea Roca',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°8 — CABA',
    numero_causa: 'CFP-9901/2024',
    estado: 'CUMPLIDO',
    fecha_hecho: '2024-02-14', fecha_recepcion: '2024-02-20',
    abogado: 'Dr. Ramón Pereyra', linea: 'LGR', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'ME-2024-00290-APN-SACO#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Pedido de causa cumplido. IPP radicada en JFCC N°8.',
  },
  // Oficio suelto — Línea Roca
  {
    id: 'P-0077/2025', area: 'PENAL', tipo: 'OFICIO',
    caratula: 'Oficio JFCC N°8 — solicitud de registro CCTV Est. Quilmes — causa CFP-9901/2024',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°8 — CABA',
    numero_causa: 'CFP-9901/2024',
    estado: 'EN_TRAMITE',
    fecha_hecho: null, fecha_recepcion: '2025-11-10',
    abogado: 'Dr. Ramón Pereyra', linea: 'LGR', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-10044-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Se solicitan imágenes de CCTV del período 14/02/2024. Coordinación con Seguridad.',
  },

  // ── PENAL: Dra. Sofía Mena — Línea Belgrano Sur ──────────────────────────
  // Causa CFP-1122/2026 — querella por vandalismo
  {
    id: 'P-0086/2026', area: 'PENAL', tipo: 'QUERELLA',
    caratula: 'SOFSE querellante — Vandalismo e incendio de material rodante Línea Belgrano Sur Est. Villa del Parque',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°6 — CABA',
    numero_causa: 'CFP-1122/2026',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2026-01-20', fecha_recepcion: '2026-02-05',
    abogado: 'Dra. Sofía Mena', linea: 'LBS', prioridad: 'ALTA',
    tiene_alerta: true, alerta_msg: 'Presentar escrito de querella antes del 30/04/2026',
    gde: 'EX-2026-00915-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'P-0087/2026', area: 'PENAL', tipo: 'CARTA_SUCESO', caratula: 'Carta Suceso SAE — incendio formación 301 LBS', estado: 'CUMPLIDO', estadoLabel: 'Carga de datos causa', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'CFP-1122/2026', abogado: 'Dra. Sofía Mena' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Incendio intencional de formación en playa de maniobras. Cuatro imputados identificados por PFA.',
  },
  {
    id: 'P-0087/2026', area: 'PENAL', tipo: 'CARTA_SUCESO',
    caratula: 'Carta Suceso SAE — incendio formación 301 Línea Belgrano Sur Est. Villa del Parque',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°6 — CABA',
    numero_causa: 'CFP-1122/2026',
    estado: 'CUMPLIDO',
    fecha_hecho: '2026-01-20', fecha_recepcion: '2026-01-21',
    abogado: 'Dra. Sofía Mena', linea: 'LBS', prioridad: 'URGENTE',
    tiene_alerta: false, alerta_msg: null,
    gde: 'MAIL-SAE-2026-0081',
    canal_ingreso: 'MAIL',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Carta Suceso SAE-0081. Procesada y convertida en querella P-0086/2026.',
  },

  // ── PENAL: Dr. Pablo Torres — Línea Sarmiento ────────────────────────────
  // Causa CFP-5540/2023 — dos oficios agrupados
  {
    id: 'P-0031/2023', area: 'PENAL', tipo: 'OFICIO',
    caratula: 'Oficio JFCC N°10 — solicitud de antecedentes disciplinarios maquinista Godoy s/ accidente Est. Once',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°10 — CABA',
    numero_causa: 'CFP-5540/2023',
    estado: 'CUMPLIDO',
    fecha_hecho: '2023-07-11', fecha_recepcion: '2023-08-02',
    abogado: 'Dr. Pablo Torres', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2023-06741-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'P-0032/2023', area: 'PENAL', tipo: 'OFICIO', caratula: 'Oficio JFCC N°10 — segunda requisitoria técnica s/ señalización Once', estado: 'EN_TRAMITE', estadoLabel: 'Respondido', tipo_relacion: 'MISMA_CAUSA', numero_causa: 'CFP-5540/2023', abogado: 'Dr. Pablo Torres' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Primer oficio respondido. Juzgado emitió segunda requisitoria (P-0032/2023).',
  },
  {
    id: 'P-0032/2023', area: 'PENAL', tipo: 'OFICIO',
    caratula: 'Oficio JFCC N°10 — segunda requisitoria: estado de señalización Est. Once — causa CFP-5540/2023',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°10 — CABA',
    numero_causa: 'CFP-5540/2023',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2023-07-11', fecha_recepcion: '2024-01-18',
    abogado: 'Dr. Pablo Torres', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2024-00712-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Coordinación con Infraestructura para relevamiento de señalización.',
  },
  // Defensa penal suelta — Línea Sarmiento
  {
    id: 'P-0095/2026', area: 'PENAL', tipo: 'DEFENSA_PENAL',
    caratula: 'Defensa penal guardia Molina, Fabián — lesiones culposas accidente Est. Castelar Línea Sarmiento',
    juzgado: 'Juzgado Federal en lo Criminal y Correccional N°10 — CABA',
    numero_causa: 'CFP-7741/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-09-30', fecha_recepcion: '2025-10-22',
    abogado: 'Dr. Pablo Torres', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'ME-2025-00981-APN-SACO#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Guardia imputado por lesiones. Asume defensa técnica SACO.',
  },

  // ── CIVIL: Dra. Elena Ruiz — Causa FSM-33100/2025 (demanda + mediación) ──
  {
    id: 'C-0052/2025', area: 'CIVIL', tipo: 'DEMANDA_CIVIL',
    caratula: 'Benítez, Claudia Mabel c/ SOFSE s/ daños y perjuicios — atropellamiento Ramos Mejía',
    juzgado: 'Juzgado Federal Civil y Comercial N°5 — CABA',
    numero_causa: 'FSM-33100/2025',
    estado: 'EN_PLAZO_CONTESTAR',
    fecha_hecho: '2025-11-03', fecha_recepcion: '2025-12-10',
    abogado: 'Dra. Elena Ruiz', linea: 'LS', prioridad: 'ALTA',
    tiene_alerta: true, alerta_msg: 'Plazo contestación vence 02/05/2026',
    gde: 'EX-2025-11204-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'C-0053/2025', area: 'CIVIL', tipo: 'MEDIACION', caratula: 'Mediación prejudicial — Benítez c/ SOFSE', estado: 'CUMPLIDO', estadoLabel: 'Cumplido (no acuerdo)', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'FSM-33100/2025', abogado: 'Dra. Elena Ruiz' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Mediación prejudicial cerrada sin acuerdo. Demanda iniciada por la actora.',
  },
  {
    id: 'C-0053/2025', area: 'CIVIL', tipo: 'MEDIACION',
    caratula: 'Mediación prejudicial — Benítez, Claudia c/ SOFSE — atropellamiento Ramos Mejía',
    juzgado: 'Centro de Mediación Prejudicial — CABA',
    numero_causa: 'FSM-33100/2025',
    estado: 'CUMPLIDO',
    fecha_hecho: '2025-11-03', fecha_recepcion: '2025-11-28',
    abogado: 'Dra. Elena Ruiz', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-10991-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Mediación cerrada sin acuerdo el 09/12/2025.',
  },
  // Dra. Elena Ruiz — expediente suelto (oficio)
  {
    id: 'C-0061/2026', area: 'CIVIL', tipo: 'OFICIO',
    caratula: 'Oficio Juzgado Federal Civil N°2 — solicitud info técnica cruce Av. San Martín s/ expediente García',
    juzgado: 'Juzgado Federal Civil y Comercial N°2 — CABA',
    numero_causa: 'FSM-44211/2024',
    estado: 'EN_TRAMITE',
    fecha_hecho: null, fecha_recepcion: '2026-03-18',
    abogado: 'Dra. Elena Ruiz', linea: 'LM', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2026-00730-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Oficio informativo. Área Infraestructura debe proveer los datos.',
  },

  // ── CIVIL: Dr. Sergio Fontana — Causa FSM-18800/2024 (demanda + beneficio) ──
  {
    id: 'C-0039/2024', area: 'CIVIL', tipo: 'DEMANDA_CIVIL',
    caratula: 'Aguirre, Néstor c/ SOFSE s/ daños y perjuicios — caída en andén Est. Constitución',
    juzgado: 'Juzgado Federal Civil y Comercial N°11 — CABA',
    numero_causa: 'FSM-18800/2024',
    estado: 'EN_PRUEBA',
    fecha_hecho: '2024-01-20', fecha_recepcion: '2024-03-05',
    abogado: 'Dr. Sergio Fontana', linea: 'LGR', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2024-02211-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'C-0040/2024', area: 'CIVIL', tipo: 'BENEFICIO_LITIGAR', caratula: 'Beneficio de litigar sin gastos — Aguirre c/ SOFSE', estado: 'CUMPLIDO', estadoLabel: 'Rechazado', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'FSM-18800/2024', abogado: 'Dr. Sergio Fontana' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Expediente en etapa probatoria. Beneficio de litigar rechazado por el juzgado.',
  },
  {
    id: 'C-0040/2024', area: 'CIVIL', tipo: 'BENEFICIO_LITIGAR',
    caratula: 'Beneficio de litigar sin gastos — Aguirre, Néstor c/ SOFSE (incidente)',
    juzgado: 'Juzgado Federal Civil y Comercial N°11 — CABA',
    numero_causa: 'FSM-18800/2024',
    estado: 'CUMPLIDO',
    fecha_hecho: null, fecha_recepcion: '2024-03-10',
    abogado: 'Dr. Sergio Fontana', linea: 'LGR', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2024-02280-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Incidente de beneficio rechazado el 15/04/2024.',
  },
  // Dr. Sergio Fontana — recupero suelto
  {
    id: 'C-0058/2026', area: 'CIVIL', tipo: 'RECUPERO',
    caratula: 'Recupero daños — colisión vehículo con barrera, Paso a nivel Florencio Varela (Línea Roca)',
    juzgado: 'Sin juzgado asignado aún',
    numero_causa: '',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2026-02-05', fecha_recepcion: '2026-02-20',
    abogado: 'Dr. Sergio Fontana', linea: 'LGR', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'ME-2026-00345-APN-SGSSL#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Pendiente de cotización de daños por parte de Infraestructura.',
  },

  // ── CIVIL: Dra. Laura Vidal — Causa FSM-27750/2025 (2 demandas agrupadas) ──
  {
    id: 'C-0047/2025', area: 'CIVIL', tipo: 'DEMANDA_CIVIL',
    caratula: 'López Díaz, Marcelo c/ SOFSE s/ daños y perjuicios — choque formación Km 12 Línea Belgrano Sur',
    juzgado: 'Juzgado Federal Civil y Comercial N°7 — CABA',
    numero_causa: 'FSM-27750/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-05-18', fecha_recepcion: '2025-07-02',
    abogado: 'Dra. Laura Vidal', linea: 'LBS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-08801-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'C-0048/2025', area: 'CIVIL', tipo: 'DEMANDA_CIVIL', caratula: 'Quintero, Ana Paula c/ SOFSE — misma formación Km 12 LBS', estado: 'EN_TRAMITE', estadoLabel: 'En trámite', tipo_relacion: 'MISMO_SINIESTRO', numero_causa: 'FSM-27750/2025', abogado: 'Dra. Laura Vidal' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Mismo siniestro que C-0048/2025. Dos actores distintos, misma formación.',
  },
  {
    id: 'C-0048/2025', area: 'CIVIL', tipo: 'DEMANDA_CIVIL',
    caratula: 'Quintero, Ana Paula c/ SOFSE s/ daños y perjuicios — choque formación Km 12 Línea Belgrano Sur',
    juzgado: 'Juzgado Federal Civil y Comercial N°7 — CABA',
    numero_causa: 'FSM-27750/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-05-18', fecha_recepcion: '2025-07-08',
    abogado: 'Dra. Laura Vidal', linea: 'LBS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-08834-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Segunda demanda del mismo siniestro. Acumulación de procesos pendiente.',
  },
  // Dra. Laura Vidal — carta documento suelta
  {
    id: 'C-0064/2026', area: 'CIVIL', tipo: 'CARTA_DOC',
    caratula: 'Carta Documento — Consorcio Propietarios Edificio Palermo c/ SOFSE — daños por obras',
    juzgado: 'Sin juzgado asignado aún',
    numero_causa: '',
    estado: 'EN_TRAMITE',
    fecha_hecho: null, fecha_recepcion: '2026-04-08',
    abogado: 'Dra. Laura Vidal', linea: 'LM', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2026-00801-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'CD recibida. Pendiente análisis y respuesta.',
  },

  // ── LABORAL: Dra. Cecilia Mora — Causa FLP-12200/2025 (2 demandas) ──
  {
    id: 'L-0022/2025', area: 'LABORAL', tipo: 'DEMANDA_LABORAL',
    caratula: 'Ibarra, Susana c/ SOFSE s/ despido injustificado — Agente Línea Belgrano Sur',
    juzgado: 'Juzgado Nacional del Trabajo N°38 — CABA',
    numero_causa: 'FLP-12200/2025',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2025-03-15', fecha_recepcion: '2025-05-20',
    abogado: 'Dra. Cecilia Mora', linea: 'LBS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-05501-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'L-0023/2025', area: 'LABORAL', tipo: 'MEDIACION', caratula: 'Mediación prejudicial — Ibarra c/ SOFSE', estado: 'CUMPLIDO', estadoLabel: 'Cumplido (no acuerdo)', tipo_relacion: 'MISMA_CAUSA', numero_causa: 'FLP-12200/2025', abogado: 'Dra. Cecilia Mora' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Despido sin causa alegado por la actora. Mediación cerrada sin acuerdo.',
  },
  {
    id: 'L-0023/2025', area: 'LABORAL', tipo: 'MEDIACION',
    caratula: 'Mediación SECLOS — Ibarra, Susana c/ SOFSE — despido Agente Línea Belgrano Sur',
    juzgado: 'Centro de Mediación Prejudicial — CABA',
    numero_causa: 'FLP-12200/2025',
    estado: 'CUMPLIDO',
    fecha_hecho: null, fecha_recepcion: '2025-04-10',
    abogado: 'Dra. Cecilia Mora', linea: 'LBS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2025-05210-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Mediación cerrada sin acuerdo el 15/05/2025.',
  },
  // Dra. Cecilia Mora — desafuero suelto
  {
    id: 'L-0029/2026', area: 'LABORAL', tipo: 'DESAFUERO',
    caratula: 'Desafuero delegado gremial Acosta, Luis — Taller Palermo Línea Mitre',
    juzgado: 'Juzgado Nacional del Trabajo N°60 — CABA',
    numero_causa: 'FLP-15540/2026',
    estado: 'EN_TRAMITE',
    fecha_hecho: '2026-02-10', fecha_recepcion: '2026-02-28',
    abogado: 'Dra. Cecilia Mora', linea: 'LM', prioridad: 'ALTA',
    tiene_alerta: true, alerta_msg: 'Informe UCIT pendiente de recepción',
    gde: 'ME-2026-00410-APN-SACO#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Delegado con fuero sindical. Requiere aval judicial para desafuero.',
  },

  // ── LABORAL: Dr. Julián Pinto — Causa FLP-9010/2024 (demanda + consignación) ──
  {
    id: 'L-0016/2024', area: 'LABORAL', tipo: 'DEMANDA_LABORAL',
    caratula: 'Vega, Roberto c/ SOFSE s/ accidente de trabajo — fractura en formación Línea Sarmiento',
    juzgado: 'Juzgado Nacional del Trabajo N°74 — CABA',
    numero_causa: 'FLP-9010/2024',
    estado: 'EN_PRUEBA',
    fecha_hecho: '2023-12-01', fecha_recepcion: '2024-02-14',
    abogado: 'Dr. Julián Pinto', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2024-01800-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [
      { id: 'L-0017/2024', area: 'LABORAL', tipo: 'CONSIGNACION', caratula: 'Consignación haberes — Vega causante fallecido (herederos en trámite)', estado: 'EN_TRAMITE', estadoLabel: 'En análisis', tipo_relacion: 'MISMA_CAUSA', numero_causa: 'FLP-9010/2024', abogado: 'Dr. Julián Pinto' },
    ],
    intervinientes: [], timeline: [], documentos: [],
    observaciones: 'El actor falleció durante el proceso. Sus herederos continúan la acción.',
  },
  {
    id: 'L-0017/2024', area: 'LABORAL', tipo: 'CONSIGNACION',
    caratula: 'Consignación haberes — Vega, Roberto (causante) — herederos denunciados en legajo',
    juzgado: 'Juzgado Nacional del Trabajo N°74 — CABA',
    numero_causa: 'FLP-9010/2024',
    estado: 'EN_TRAMITE',
    fecha_hecho: null, fecha_recepcion: '2024-08-20',
    abogado: 'Dr. Julián Pinto', linea: 'LS', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'ME-2024-00701-APN-SACO#SOFSE',
    canal_ingreso: 'MEMO_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Se consignan haberes impagos por no poder identificarse a todos los herederos.',
  },
  // Dr. Julián Pinto — oficio laboral suelto
  {
    id: 'L-0031/2026', area: 'LABORAL', tipo: 'OFICIO',
    caratula: 'Oficio JNT N°80 — solicitud liquidación haberes impagos — causa Torres c/ SOFSE',
    juzgado: 'Juzgado Nacional del Trabajo N°80 — CABA',
    numero_causa: 'FLP-20110/2026',
    estado: 'EN_TRAMITE',
    fecha_hecho: null, fecha_recepcion: '2026-04-14',
    abogado: 'Dr. Julián Pinto', linea: 'LM', prioridad: 'NORMAL',
    tiene_alerta: false, alerta_msg: null,
    gde: 'EX-2026-00871-APN-SACO#SOFSE',
    canal_ingreso: 'EE_GDE',
    vinculos: [], intervinientes: [], timeline: [], documentos: [],
    observaciones: 'Oficio informativo. Coordinación con RRHH para liquidación.',
  },
];
...
const FORMULARIOS = {
  ...
  DEFENSA_CIVIL: {
    label: 'Defensa Civil',
    nota: 'Sin campos de formulario. Los estados se gestionan desde el cambio de estado del expediente.',
    mesa: [],
    abogado: [],
  },
  ...
  BENEFICIO_LITIGAR: {
    ...
    mesa: [],
    abogado: [],
    nota: 'Campos pendientes de definición por el cliente.',
  },
