...
const EXPEDIENTES_ABOGADO = [
...

  {
    ...
    abogado: 'Vetrano, Magdalena', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Ferrari, Jessica', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Escalante, Carolina', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Perez, Fernanda', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Russo, Mauricio', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    fecha_recepcion: '2026-04-01',
    abogado: 'Molinelli, Rodrigo', linea: null,
...

  {
    ...
    abogado: 'Pires, Daiana', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Wilson, Eduardo', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Benitez, Adriana', linea: null,
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
...

  {
    ...
    abogado: 'Prinotti, Maximiliano', linea: 'LIN_004',
    tiene_alerta: false, alerta_msg: null,
    prioridad: 'NORMAL', vinculos: [], intervinientes: [],
    campos_mesa: {},
    campos_abogado: {},
