...
function renderSidebar(activePage) {
  ...
  const allNav = [
    ...
    { key: 'bandeja-area',    svg: '<svg xmlns="http://www.w3.org/2000/svg" class="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/></svg>', label: 'Bandeja Área', href: 'bandeja-area.html' },
...
function selectUser(userId) {
  ...
  const mainNavKeys = ['dashboard', 'mesa-saco','bandeja-abogado','bandeja-area','alta-expediente','reports'];
